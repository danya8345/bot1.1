...
// embed
  ...
  if ( cmd === "help") {
    ...
    .setAuthor({name:"bot by danya",iconURL:'https://cdn.betterttv.net/emote/5a5e0e8d80f53146a54a516b/3x'})
    .setTimestamp()
  ...
  if (cmd === "clear")
  {
    if (!msg.member.hasPermission("MANAGE_MESSAGES")) return msg.channel.send("cant delete(permission)")
